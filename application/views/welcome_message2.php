...
<html lang="en">
    <head>
        ...
        <title>KARANG TARUNA 05 - Welcome</title>
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">KARANG TARUNA 05</a>
        ...
        <header class="masthead">
            <div class="container d-flex h-100 align-items-center">
                <div class="mx-auto text-center">
                    <h1 class="mx-auto my-0 text-uppercase">KARANG TARUNA 05</h1>
                    <h2 class="text-white-50 mx-auto mt-2 mb-5">NAWASENA PEMUDA DESA 05</h2>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        <h2 class="text-white mb-4">NAWASENA 05</h2>
                        <p class="text-white-50">
                        NAWASENA ADALAH SEBUAH KOMUNITAS YANG DIBUAT OLEH KARANG TARUNA 05.
                        </p>
                    </div>
                </div>
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card py-4 h-100">
                            <div class="card-body text-center">
                                ...
                                <hr class="my-4" />
                                <div class="small text-black-50"><span style="cursor: pointer" onclick="open_map()">Cipicung Girang RT05 RW10 CIUMBULEUIT, CIDADAP, KOTA BANDUNG</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card py-4 h-100">
                            <div class="card-body text-center">
                                ...
                                <hr class="my-4" />
                                <div class="small text-black-50"><span style="cursor: pointer" onclick="send_email()">KARANGTARUNAV@GMAIL.COM</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card py-4 h-100">
                            <div class="card-body text-center">
                                ...
                                <hr class="my-4" />
                                <div class="small text-black-50"><span style="cursor: pointer" onclick="send_wa()">+62 856-2316-375</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="social d-flex justify-content-center">
                    <a class="mx-2" href="https://wa.me/+62856231637"><i class="fab fa-whatsapp"></i></a>
        ...
        <!-- Footer-->
        <footer class="footer bg-black small text-center text-white-50"><div class="container">Copyright © <a href="">SETIADI</a> 2024</div></footer>
        <!-- Bootstrap core JS-->
...
<script>
    function send_email() {
        window.open("https://mail.google.com/mail/?view=cm&fs=1&to=KARANGTARUNAV@GMAIL.COM);
    }
    function send_email() {
        window.open("https://wa.me/+628562316375");
    }
    function open_map() {
        window.open("https://maps.app.goo.gl/fC2X7pcNzsREBvuA6");
    }
</script>